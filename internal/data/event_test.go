...
func TestEvent_GetAllEvents_ValidEvents_Successful(t *testing.T) {
	...
	newEvent2, _ := db.AddEvent(testEvent2.EventType, testEvent2.Details, "127.0.0.1", 2*time.Hour)
	db.AddEvent(testEvent3.EventType, testEvent3.Details, "127.0.0.1", 2*time.Hour)
