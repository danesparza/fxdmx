...
var rootCmd = &cobra.Command{
	Use:   "fxdmx",
	Short: "REST service for DMX fixture control from Raspberry Pi",
	Long: `REST service for DMX fixture control from Raspberry Pi. 
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/fxdmx.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName("fxdmx") // name the config file (without extension)
	}
	...
	viper.SetDefault("server.port", 3040)
